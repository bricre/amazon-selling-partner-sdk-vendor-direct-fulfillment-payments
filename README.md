# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Direct Fulfillment Payments
...
```shell
composer require bricre/amazon-selling-partner-sdk-vendor-direct-fulfillment-payments
```
...
```php
<?php
use Amz\VendorDirectFulfillmentPayments\ResponseTypes;
